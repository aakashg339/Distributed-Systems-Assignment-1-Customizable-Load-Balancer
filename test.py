...
# Endpoint 5: /<path> (GET) with invalid endpoints
path_endpoint_url = f"{base_url}/abc" 
path_response = requests.get(path_endpoint_url)
print("Endpoint /abc:")
print("Request URL:", path_endpoint_url)
print("Response :", path_response.json())

# Endpoint 5: /<path> (POST) with invalid endpoints
path_endpoint_url = f"{base_url}/abc" 
path_response = requests.get(path_endpoint_url)
print("Endpoint /abc:")
print("Request URL:", path_endpoint_url)
...
# Endpoint 5: / (POST) with invalid endpoints
path_endpoint_url = f"{base_url}/" 
path_response = requests.get(path_endpoint_url)
print("Endpoint /:")
print("Request URL:", path_endpoint_url)
print("Response :", path_response.json())
